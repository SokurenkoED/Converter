...
namespace Converter__from_dat_to_xml_
{
    class Program
    {
        ...
        static async System.Threading.Tasks.Task Main(string[] args)
        {
            ...
            //                            ReadStar(ref ArrayOfVolid, ref ArrOfStr, i, formatter); // Проверяем на *
            //                            double ChekErr = 0;
            //                            if (!(ArrOfStr.Length == 5 || ArrOfStr.Length == 4))
            //                            {
            ...
            //                                else
            //                                {
            //                                    throw new NotImplementedException("Ошибка в объеме с уровнем");
            //                                }
            ...
            //                        try
            //                        {
            //                            if (double.Parse(VLV_TBL[0], formatter) != 0)
            //                            {
            ...
            //                if (ArrOfStr[2] == "AZ_OUT" && ArrOfStr[1] == "D_Pow")
            //                {
            ...
            //                if (double.Parse(CountELL, formatter) != 0 )
            //                {
